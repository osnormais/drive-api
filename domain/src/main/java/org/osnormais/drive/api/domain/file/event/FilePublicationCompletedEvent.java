...
public class FilePublicationCompletedEvent extends DomainEvent<FileId> {
    ...
    public static FilePublicationCompletedEvent create(final File file) {
        return new FilePublicationCompletedEvent(
                file,
                Instant.now(),
                List.of(
