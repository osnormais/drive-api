...
@Component
public class FileCreatedIntegrationHandlerTeste2 extends DomainEventHandler<FileCreatedEvent> {

    private static final UUID UNIQUE_ID = UUID.randomUUID();
    private final FileQueryGateway fileQueryGateway;

    protected FileCreatedIntegrationHandlerTeste2(final FileQueryGateway fileQueryGateway) {
